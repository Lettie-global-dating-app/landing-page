...
const blogPosts = [
  {
    ...
    excerpt: '끊임없는 알림과 즉각적인 반응의 시대. 정신 건강을 지키고 진정한 관계를 회복하기 위한 디지털 디톡스와 느린 소통의 중요성을 이야기합니다.',
    date: '2025-01-25',
    readTime: '6분',
    category: '감성',
  ...
  },
  {
    ...
    excerpt: '온라인에서 새로운 친구를 만나는 것은 설레는 일이지만, 안전이 최우선입니다. Lettie가 제안하는 안전한 펜팔 수칙과 프라이버시 보호 방법.',
    date: '2025-01-24',
    readTime: '5분',
    category: '가이드',
