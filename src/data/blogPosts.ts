export type BlogPost = {
    ...
    updated?: string;
    /** 검색 결과용 짧은 제목 (60칸 안). 화면 제목은 title 그대로. */
    seoTitle?: string;
    seoTitleEn?: string;
};
...
**P.S.** — If you write to me, don't worry about being "too much." The people I like best always are. So am I.
    ...
    'dear-stranger': {
        ...
        seoTitleEn: 'Dear Stranger: A Letter About Slow, Deep Connection',
...
**Meet friends from around the world waiting for you on Lettie.**
    ...
    'penpal-culture-guide': {
        ...
        seoTitleEn: 'Letter Etiquette Around the World for Pen Pals',
...
Lettie connects people from diverse cultural backgrounds. Respect and understand each other's differences, and create genuine global friendships.
    ...
    'language-exchange-tips': {
        ...
        seoTitleEn: 'Language Exchange Through Pen Pals: Methods That Work',
...
*P.S. How is your morning? Is it misty, or is the sunlight already shining? Either way, I want to hear your story.*
    ...
    'dearest-friend': {
        ...
        seoTitleEn: 'Letter on an Autumn Night: Sharing Loneliness',
...
*Let's build a safe and healthy penpal culture together.*
    ...
    'making-global-friends': {
        ...
        seoTitleEn: 'Making Global Friends Beyond Language and Borders',
...
*Lettie와 함께 언어의 장벽을 넘어 마음을 나누는 친구를 만나보세요.*
        ...
        seoTitleEn: 'From Language Exchange to Real Friendship',
...
*Lettie와 함께 편견 없는 세상, 경계 없는 우정을 만들어가세요.*
        ...
        seoTitleEn: 'Pen Pal Etiquette and Cultural Differences',
...
*Create a world without prejudice, friendship without boundaries with Lettie.*
    ...
    'digital-detox-penpal': {
        ...
        seoTitleEn: 'Digital Detox With Pen Pals: Slow Communication',
...
*Genuine connection starts with slowness. Experience digital detox with Lettie.*
    ...
    'international-friendship-guide': {
        ...
        seoTitle: '외국인 친구 사귀기 가이드: 글로벌 펜팔',
        seoTitleEn: 'How to Make International Friends Through Pen Pals',
...
*Go global with Lettie. Your global friends are waiting.*
    ...
    'self-growth-through-penpal': {
        ...
        seoTitleEn: 'Growing Through Pen Pals: Self-Reflection in Letters',
...
`
    ...
    'korean-pen-pals': {
        ...
        seoTitleEn: 'How to Find a Korean Pen Pal (and Keep Writing)',
...
`
    ...
    'what-to-write-to-a-pen-pal': {
        ...
        seoTitleEn: 'What to Write to a Pen Pal: 40 Ideas That Get Replies',
...
`
    ...
    'japanese-pen-pals': {
        ...
        seoTitleEn: 'How to Find a Japanese Pen Pal Who Writes Back',
...
`
    ...
    'keep-a-pen-pal-conversation-going': {
        ...
        seoTitleEn: 'How to Keep a Pen Pal Conversation Going',
...
`,
    ...
    'letter-delivery-time-by-distance': {
        ...
        seoTitle: '편지 도착 시간: 도시별 배달 시간표',
        seoTitleEn: 'How Long Does a Letter Take? Delivery Times by City',
