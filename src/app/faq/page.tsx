...
export const metadata: Metadata = {
  title: { absolute: 'Lettie 펜팔 앱 자주 묻는 질문' },
    ...
    questions: [
      {
        ...
        a: '네. 편지는 지구본 위를 실제로 날아갑니다. 두 나라 사이 거리로 걸리는 시간이 정해져서, 가까운 나라는 몇 시간, 지구 반대편은 하루쯤 걸려 도착합니다. 기다리는 동안 지구본에서 편지가 어디쯤 가고 있는지 볼 수 있습니다.'
      },
      {
        q: '발견은 뭔가요?',
